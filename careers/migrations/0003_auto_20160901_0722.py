...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('careers', '0002_auto_20160514_000000'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='jobpost',
            options={'ordering': ('-publish_date',), 'verbose_name': 'Job Post', 'verbose_name_plural': 'Job Posts'},
        ),
